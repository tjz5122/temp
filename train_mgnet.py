...
if __name__ == "__main__":
    ...
    parser.add_argument('--num-channel-u', type=int, help='number of channels of u', default=128)
    parser.add_argument('--num-channel-f', type=int, help='number of channels of f', default=128)
