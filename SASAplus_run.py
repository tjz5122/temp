...
# flexible
ordered_param_group = ['model_group', 'lr_group', 'wd_group', 'trail_group', 'drop_factor_group', 'batch_size_group', 'epochs_group', 
                       'leaky_group', 'momentum_group', 'dampening_group', 'significance_group', 'ministat_group', 'varmode_group', 'data_group' ]
value_list = [test_param_groups[group] for group in ordered_param_group]
test_list = list(product(*value_list))
command = 'python SASAplus_train.py --cuda --model={} --lr={} --wd={} --trail={} --drop={} --batchsize={} --epochs={} --lk={} --momentum={} --dampening={} --sig={} --minstat={} --vm={} --data={}'
# flexible
