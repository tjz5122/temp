...
optimizer = optim.SGD(my_model.parameters(), lr=lr, momentum=momentum, dampening=dampening, weight_decay=wd)
#optimizer = SSM(my_model.parameters(), lr=lr, weight_decay=wd, momentum=momentum, dampening=dampening, testfreq=testfreq, var_mode=varmode, 
